...
def get_args():
    ...
    parser.add_argument(
        '--load_path', type=str, default='params/detr-r50-e632da11.pth', required=False,
    )
    parser.add_argument(
        '--save_path', type=str, default='params/detr--pre-vcoco-qg.pth', required=False,
    )
    parser.add_argument(
...
def main(args):
    ...
    #     print(k)
    #     if 'decoder' in k:
    #         ps['model'][k.replace('layers', 'verb_layers')] = ps['model'][k].clone()
